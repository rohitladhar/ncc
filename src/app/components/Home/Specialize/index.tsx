...
const Specialize = () => {
  ...
  return (
    <section id="specialize" className="scroll-mt-12">
      <div className="container">
        <div className="text-center mb-8">
          <h2 className="mb-6">
            Why Choose <span className="text-primary">NCC</span>
          </h2>
          <p className="text-lg font-normal max-w-2xl mx-auto dark:text-white  text-primary">
            Excellence, reliability, and professionalism in every service
          </p>
        </div>
            ...
            : specialization.map((item, i) => (
                <div key={i}>
                  <div className="bg-secondary dark:bg-darklight rounded-lg p-8">
                    ...
                    <div>
                      <h5 className="font-bold mb-2 dark:text-white  text-primary">
                        {item.title}
                      </h5>
                      <p className="text-base font-normal max-w-xs dark:text-white  text-primary">
                        {item.desc}
                      </p>
                    </div>
                  </div>
